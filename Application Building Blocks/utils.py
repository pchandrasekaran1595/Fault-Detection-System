...
# Webcam Feed/Capture DEvice Attirbutes
...
# Length of the feature vector extracted from the deep learning model
FEATURE_VECTOR_LENGTH = 2048 # or 25088

# Color Scheme for CLI and CUI Application
...
def get_box_coordinates(model, transform, image):
    ...
    temp_image = preprocess(temp_image)
...
def get_single_image_features(model, transform, image):
    """
